...
bool TC_URL::parseURL(const string &sURL)
{
    ...
    //完善url, www.qq.com?a=b/c ==> www.qq.com/?a=b/c   www.qq.com?a=b ==> www.qq.com/?a=b
    //完善url, www.qq.com#ab/c ==> www.qq.com/#a=b/c    www.qq.com#abc ==> www.qq.com/#a=b
...
bool TC_HttpRequest::decode(const char *sBuffer, size_t iLength)
{
    ...
    if(strncasecmp(sBuffer, "GET " ,4) !=0 && strncasecmp(sBuffer, "POST " ,5) !=0 && strncasecmp(sBuffer, "OPTIONS " ,5) !=0)
    {
        throw runtime_error("[TC_HttpRequest::checkRequest] protocol not support, only support GET POST and OPTIONS ");
    }
